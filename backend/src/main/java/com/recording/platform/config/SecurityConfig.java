...
public class SecurityConfig {
	...
	SecurityFilterChain securityFilterChain(
		...
		http.authorizeHttpRequests((requests) -> requests
			...
			.requestMatchers(HttpMethod.GET, "/api/media/public/reference/*").permitAll()
			...
			.requestMatchers(HttpMethod.POST, "/api/reviews/claim", "/api/reviews/claim-batch")
				.hasRole("REVIEWER")
			.requestMatchers(HttpMethod.POST, "/api/reviews/assign", "/api/reviews/batch/approve")
				.hasRole("ADMIN")
			.requestMatchers(HttpMethod.PUT, "/api/reviews/tasks/*/ai-config")
				.hasRole("ADMIN")
