...
| 领域 | 已实现能力 |
|---|---|
| Web 管理 | ADMIN/REVIEWER 登录与会话接管、角色路由、真实数据大屏、ADMIN 邀请码创建/脱敏查看/永久停用、任务配置、编号/状态/采集员/结果悬浮多选数据池、原位编辑条目详情、CSV 导入、三目录分页权限管理、审核、用户、操作记录、跨页异步批处理，以及带任务、人员、日期筛选和采集员排名的统计 |
