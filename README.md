...
| 微信小程序 | `apps/miniprogram/` | 采集员登录、资料、权限申请、任务领取、录音/文字提交、返修和结果查看 |
...
| 小程序采集 | 微信/数字账号登录、独立资料与头像、任务授权、领取、录音、文本补充、返修、提交后自动领取和个人统计 |
...
- 小程序仅面向重庆砚数科技有限公司内部员工及经授权的录音采集人员；登录板块下方常驻展示使用范围，不增加游客模式。
