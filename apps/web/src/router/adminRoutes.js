...
export const adminRoutes = {
  ...
  children: [
    ...
    { path: 'platforms', component: () => import('../pages/admin/platforms/PlatformListPage.vue'), meta: { title: '平台管理', roles: ['ADMIN'] } },
    { path: 'tasks', component: () => import('../pages/admin/tasks/TaskListPage.vue'), meta: { title: '任务与数据池', roles: ['ADMIN'] } },
