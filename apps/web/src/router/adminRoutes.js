...
export const adminRoutes = {
  ...
  children: [
    { path: 'dashboard', component: () => import('../pages/admin/dashboard/AdminDashboard.vue'), meta: { title: '数据大屏', roles: ['ADMIN'] } },
    ...
    { path: 'tasks/:id/edit', component: () => import('../pages/admin/tasks/TaskEditorPage.vue'), meta: { title: '编辑草稿任务', roles: ['ADMIN'] } },
    ...
    { path: 'review/tasks/:taskId/ai-settings', component: () => import('../pages/admin/review/ReviewAiSettingsPage.vue'), meta: { title: 'AI 辅助审核设置', roles: ['ADMIN'] } },
    { path: 'review/:itemId', component: () => import('../pages/admin/review/ReviewWorkbenchPage.vue'), meta: { title: '审核工作台', roles: ['ADMIN', 'REVIEWER'] } },
    { path: 'reports/tasks', redirect: '/admin/dashboard', meta: { title: '数据大屏', roles: ['ADMIN'] } },
    { path: 'reports/collectors', name: 'collector-statistics', component: () => import('../pages/admin/reports/CollectorStatisticsPage.vue'), meta: { title: '采集员统计', roles: ['ADMIN'] } },
    { path: 'reports/tasks/:taskId/collectors/:collectorId', name: 'collector-statistics-detail', component: () => import('../pages/admin/reports/CollectorStatisticsDetailPage.vue'), meta: { title: '采集员统计详情', roles: ['ADMIN'] } },
